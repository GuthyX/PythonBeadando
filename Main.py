...
class Background(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        # Texturák létrehozása
        self.cloud_texture = Image(source="Kepek/cloud.png").texture
        self.cloud_texture.wrap = 'repeat'
        self.cloud_texture.uvsize = (Window.width / self.cloud_texture.width, -1)

        self.floor_texture = Image(source="Kepek/ground.png").texture
...
class Bird(Image):
    ...
    def on_touch_down(self, touch):
        self.source = "Kepek/bird2.png"
        self.velocity = 150
        super().on_touch_down(touch)

    def on_touch_up(self, touch):
        self.source = "Kepek/bird1.png"
...
class MainApp(App):
    ...
    def check_collision(self):
        bird = self.root.ids.bird
        # Két pipe közötti áthaladás vizsgálata
        is_colliding = False
        for pipe in self.pipes:
            if pipe.collide_widget(bird):
                is_colliding = True
                # Megvizsgálni hogy a player két pipe között van
    ...
    def move_pipes(self, time_passed):
        ...
        # Ujra pozicionálás jobbra ha kell
        num_pipes = 5
        distance_between_pipes = Window.width / (num_pipes - 1)
